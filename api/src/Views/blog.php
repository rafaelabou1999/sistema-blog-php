...
<?php
    ...
    $url_deploy = "https://cineluzes.vercel.app";
?>
...
<head>
    ...
    <link href="<?= $url_deploy;?>/css/blog.css" rel="stylesheet">
    <link href="<?= $url_deploy;?>/css/geral.css" rel="stylesheet">
...
<?php if($title):?>
    <?php if(array_key_exists($title, $posts) && isset($posts[$title])):?>
        ...
        <div class="has_title">
            <div class="path_display"><a window.location.href="<?php $url_deploy . "/public/index.php"?>">Home</a> 🢚 <span>Blog</span></div>
    ...
    <?php else: ?>
        <div class="post_error">
            <h4>Título ainda não criado!</h4>
            <button><a href="./new_post.php">Faça seu Post</a></button>
        </div> 
    <?php endif; ?>
<?php else: ?>
    <div class="post_error">
